      ...
      <div class="bg-white shadow w1200 projects_form">
        ...
        <el-form :model="launchForm" status-icon :rules="launchRules" ref="launchForm" class="launch_form w630">
          <el-form-item label="项目名称" prop="name">
            <el-input v-model="launchForm.name">
            </el-input>
          </el-form-item>
          <el-form-item label="电子邮件" prop="mail">
            <el-input v-model="launchForm.mail">
            </el-input>
          </el-form-item>
          <el-form-item label="Token全名" prop="tokenName">
            <el-input v-model="launchForm.tokenName">
            </el-input>
          </el-form-item>
          <el-form-item label="Token缩写" prop="tokenSymbol">
            <el-input v-model="launchForm.tokenSymbol">
            </el-input>
          </el-form-item>
          <el-form-item label="可挖Token数量" prop="tokenNumber">
            <el-input v-model="launchForm.tokenNumber">
            </el-input>
          </el-form-item>
          <el-form-item label="官网地址" prop="officialAddress">
            <el-input v-model="launchForm.officialAddress">
            </el-input>
          </el-form-item>
          <el-form-item label="项目介绍" prop="introduce">
            <el-input type="textarea" v-model="launchForm.introduce">
            </el-input>
          </el-form-item>
          <el-form-item label="主要功能点" prop="functionalPoint">
            <el-input type="textarea" v-model="launchForm.functionalPoint">
            </el-input>
          </el-form-item>
          <el-form-item label="经济模型" prop="economicModel">
            <el-input type="textarea" v-model="launchForm.economicModel">
            </el-input>
          </el-form-item>
